...
const validateTName = (value) => { return (/^([a-zA-Z0-9%:?',_]+\s)*[a-zA-Z0-9%:'?,_]{2,50}$/).test(value)}
const isvalidName= (value)=>(/^([a-zA-Z0-9%:?',_]+\s)*[a-zA-Z0-9%:?',_]{2,50}$/).test(value)



module.exports = { checkInputsPresent,isvalidName, checkString, validateTName,validatePincode, validateName,  validateEmail, validatePassword, validateTitle, validateMobileNo, validateISBN, validateDate }